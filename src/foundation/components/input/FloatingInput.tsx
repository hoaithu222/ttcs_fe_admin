...
const FloatingInput = React.forwardRef<HTMLInputElement, FloatingInputProps>(
  (
    ...
    const labelColor = {
      default: isFocused ? "text-input-border-focus" : "text-input-label",
      success: "text-success",
      error: "text-error",
      warning: "text-warning",
    };
          ...
          <div className="flex absolute right-4 top-1/2 gap-2 items-center -translate-y-1/2">
            {showPasswordToggle && (
              <button
                ...
                className="p-1 text-input-placeholder rounded-lg transition-colors duration-200 hover:text-input-text hover:bg-background-2"
                tabIndex={-1}
              >
