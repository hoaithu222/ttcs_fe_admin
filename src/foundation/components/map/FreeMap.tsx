...
// Normalize default marker icons once to avoid broken assets in bundlers.
 ...
 * FreeMap
 *
 * Lightweight Leaflet wrapper that uses OpenStreetMap tiles without API keys.
 * - Provide `markerPosition` to render a marker.
 * - Pass `onMarkerChange` to allow users to drop a new marker via map clicks.
 */
const FreeMap = ({
